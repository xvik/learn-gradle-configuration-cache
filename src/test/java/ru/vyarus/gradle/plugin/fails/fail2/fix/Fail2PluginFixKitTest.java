 ...
 * @since 05.09.2025
 */
public class Fail2PluginFixKitTest extends AbstractKitTest {
    ...
    void testConfigurationCache() {
        ...
        BuildResult result = run("fail2Fix", "fail2Fix2", "--configuration-cache", "--configuration-cache-problems=warn");
