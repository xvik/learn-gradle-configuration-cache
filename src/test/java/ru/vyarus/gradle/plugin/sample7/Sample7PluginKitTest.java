 ...
 * @since 10.08.2025
 */
public class Sample7PluginKitTest extends AbstractKitTest {
    ...
    void testConfigurationCache() {
        ...
        BuildResult result = run("sample7Task", "--configuration-cache", "--configuration-cache-problems=warn");
        ...
        System.out.println("\n\n------------------- FROM CACHE ----------------------------------------");
        result = run("sample7Task", "--configuration-cache", "--configuration-cache-problems=warn");
